...
//
// Mirror of src/engines/types.ts — kept in lockstep by hand (Deno edge
// functions bundle their own dependencies, they cannot import from the
// Vite app's src/ tree). DO NOT modify formulas here without mirroring the
// change back into src/engines/types.ts, and vice versa.
